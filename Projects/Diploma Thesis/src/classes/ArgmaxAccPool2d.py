...
class ArgmaxAccPool2d(_AccPool2d):
    """ Counts the amount of times each element in a 2d grid was the winner of a max pooling operation.
    ...
    Example:
        ...
        >>> input = torch.Tensor([[[
              ...
              [5, 6, 7, 8, 9, 1, 2, 3, 4],
              [9, 8, 7, 6, 5, 4, 3, 2, 1]]]])
        >>> c = ArgmaxAccPool2d(kernel_size=(2, 2), stride=(1, 1))
        >>> c(input)
    ...
    def __init__(self, *args, **kwargs):
        super(ArgmaxAccPool2d, self).__init__(*args, **kwargs)
