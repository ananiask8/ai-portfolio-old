...
if __name__=="__main__":
    ...
    # games = [("pacman", "games/pacman_5.game"),]
    games = [("grid", "games/grid_3.game"),
            ("grid", "games/grid_4.game"),
            ("grid", "games/grid_5.game"),
            ("pacman", "games/pacman_3.game"),
            ("pacman", "games/pacman_4.game"),
            ("pacman", "games/pacman_5.game"),
            ("pacman_small", "games/pacman_small_3.game"),
            ("pacman_small", "games/pacman_small_4.game")]
