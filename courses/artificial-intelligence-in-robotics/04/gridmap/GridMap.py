...
class GridMap:
    ...
    def dist_euclidean_considering_obstacles(self, coord1, coord2):
        if self.passable(coord2) and self.probably_passable(coord2):
            return np.inf
        return self.dist_euclidean(coord2, coord1)
    ...
    def cost_manhattan_considering_obstacles(self, coord1, coord2):
        if self.passable(coord2) and self.probably_passable(coord2):
            return np.inf
        return self.cost_manhattan(coord2, coord1)
