...
def toStr(term: 'Term or Atom') -> str:
    return array.array('b', JSMU.name(term)).tostring().decode('utf-8')
...
class CompoundTerm(Term):
    ...
    def getVariables(self) -> Set[Variable]:
        ...
        :rtype: set of Variable
        '''
        return tools.unionSets(term.getVariables() for term in self.terms)
    ...
    def getFunctors(self) -> Set[Functor]:
        ...
        result = result.union(tools.unionSets(map(lambda term: term.getFunctors(), self.terms)))
        return result
...
class Atom:
    ...
    def getConstants(self) -> Set[Constant]:
        ...
        :rtype: set of Constant
        '''
        return tools.unionSets(term.getConstants() for term in self.terms)
    ...
    def getFunctors(self) -> Set[Functor]:
        ...
        :rtype: set of Functor
        '''
        return tools.unionSets(map(lambda term: term.getFunctors(), self.terms))
...
class Literal:
    def __init__(self, atom: Atom, positive: bool = True):
        ...
        :rtype: Literal
        '''
        self.lit: JLiteral = JLiteral(atom.predicate.name, positive, toJava(atom.terms))
        self.atom: Atom = atom
...
class Clause(Iterable[Literal]):
    ...
    def getVariables(self) -> Set[Variable]:
        ...
        if not self.literals:
            return set()
        return tools.unionSets(literal.getVariables() for literal in self.literals)
...
class CNF:
    ...
    def getPredicates(self) -> Set[Predicate]:
        ...
        :rtype: set of Predicate
        '''
        return tools.unionSets(clause.getPredicates() for clause in self.clauses)
    ...
    def getGroundLiterals(self) -> Set[Literal]:
        ...
        :rtype: set of Literal
        '''
        return tools.unionSets(clause.getGroundLiterals() for clause in self.clauses)
    ...
    def getNegativeLiterals(self) -> Set[Literal]:
        ...
        :rtype: set of Literal
        '''
        return tools.unionSets(clause.getNegativeLiterals() for clause in self.clauses)
    ...
    def getPositiveLiterals(self) -> Set[Literal]:
        ...
        :rtype: set of Literal
        '''
        return tools.unionSets(clause.getPositiveLiterals() for clause in self.clauses)
    ...
    def getLiterals(self) -> Set[Literal]:
        ...
        :rtype: set of Literal
        '''
        return tools.unionSets(clause.literals for clause in self.clauses)
...
class Interpretation:
    ...
    def getConstants(self) -> Set[Constant]:
        ...
        :rtype: set of Constant
        '''
        return tools.unionSets(atom.getConstants() for atom in self.atoms)
    ...
    def getFunctors(self) -> Set[Functor]:
        ...
        :rtype: set of Functor
        '''
        return tools.unionSets(map(lambda atom: atom.getFunctors(), self.atoms))
...
def toPython(java: 'JavaLogic') -> 'PythonLogic':
    ...
    if isinstance(java, JLiteral):
        ...
        return Literal(atom, not java.isNegated())
