...
if __name__ == "__main__":
    ...
    experiments = {
        "greedy-avg": {"epsilon": [1/128, 1/64, 1/32, 1/16, 1/8, 1/4]},
        "greedy-lr=.15": {"alpha": 0.15, "epsilon": [1/128, 1/64, 1/32, 1/16, 1/8, 1/4]},
        "greedy-lr=.15-init=1": {"alpha": 0.15, "initial": 1, "epsilon": [1/128, 1/64, 1/32, 1/16, 1/8, 1/4]},
        "ucb": {"c": [1/4, 1/2, 1, 2, 4]},
